...
public class loginSteps {
    ...
    public void user_should_be_navigated_to_the_search_hotel_page() {
       WebElement search_Hotel =  driver.findElement(By.xpath("//a[text()='Search Hotel']"));
        String tab = Keys.chord(Keys.CONTROL,Keys.RETURN);
        search_Hotel.sendKeys(tab);

    }


    @Given("User navigated to search hotel page after Login")
    public void user_navigated_to_search_hotel_page_after_login() {
      WebElement searchHotel =  driver.findElement(By.xpath("//a[text()='Search Hotel']"));
